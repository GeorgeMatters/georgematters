...
(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([[42], {
    ...
    7480: (e, t, n) => {
        ...
        t.default = elementorModules.frontend.handlers.Base.extend({
            ...
            onInit() {
                if (this.menuHeightController = new elementorProFrontend.utils.DropdownMenuHeightController(this.dropdownMenuHeightControllerConfig()), elementorModules.frontend.handlers.Base.prototype.onInit.apply(this, arguments), !this.elements.$menu.length)
                    return;
