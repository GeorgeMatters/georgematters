    ...
    var R = function(t) {
        ...
        if (B) {
            var S = navigator.userAgent,
                H = new Date;
            try {
                (b = l.localStorage) ? (b.setItem(H, H), B = b.getItem(H) == H, b.removeItem(H)) : B = !1,
                B || (b = {})
            } catch (S) {
                B = !1
            }
        ...
        if (K.forEach((function(e) {
            ...
            if (Z || function t(e) {
                for (var n in e)
                    Z || ("slideBy" === n && (e[n] = "page"), "edgePadding" === n && (e[n] = !1), "autoHeight" === n && (e[n] = !1)),
                    "responsive" === n && t(e[n])
            }(t), !Z) {
                t.axis = "horizontal",
                t.slideBy = "page",
            ...
            At || Nn(we || Te),
            W && (re = W, oe = "translate", q ? (oe += lt ? "3d(" : "3d(0px, ", ue = lt ? ", 0px, 0px)" : ", 0px)") : (oe += lt ? "X(" : "Y(", ue = ")")),
            ...
            function() {
                ...
                if (lt && (P || At ? (f(Ut, "#" + be + " > .tns-item", "font-size:" + l.getComputedStyle(pt[0]).fontSize + ";", d(Ut)), f(Ut, "#" + be, "font-size:0;", d(Ut))) : Z && v(pt, (function(t, e) {
                    ...
                    f(Ut, "#" + be + "-iw", a, d(Ut)),
                    Z && (a = lt && !At ? "width:" + zn(t.fixedWidth, t.gutter, t.items) + ";" : "", F && (a += jn(It)), f(Ut, "#" + be, a, d(Ut))),
            ...
            var En = zt ? Z ? function() {
                ...
                An = Z ? function() {
                    var t,
                        ...
                        c;
                    Ci(ft, ""),
                    F || !It ? (Ni(), It && A(ft) || Hi()) : (t = ft, e = re, n = oe, i = ue, a = Ei(), r = It, o = Hi, u = Math.min(r, 10), l = 0 <= a.indexOf("%") ? "%" : "px", a = a.replace(l, ""), s = Number(t.style[e].replace(n, "").replace(i, "").replace(l, "")), c = (a - s) / r * u, setTimeout((function a() {
                        r -= u,
                        s += c,
                        t.style[e] = n + s + l + i,
            ...
            return {
                ...
                destroy: function() {
                    ...
                    })), K = nt = it = at = rt = lt = st = ct = ft = dt = vt = pt = ht = ut = mt = At = Nt = Lt = Bt = St = Ot = Dt = kt = Rt = It = Pt = zt = Wt = Ut = _t = gt = $t = te = ee = ne = ie = ae = re = oe = ue = le = se = ce = fe = de = pe = he = me = ye = ge = xe = be = we = Ce = Me = Te = Ee = Ae = Ne = Le = Be = Se = He = Oe = De = ke = Re = Ie = Pe = ze = We = Fe = je = xt = qt = Ft = Xe = Ye = Ke = Je = Ge = Qe = jt = $e = tn = Ze = en = nn = an = rn = on = un = ln = sn = Qt = Xt = hn = Yt = Kt = mn = yn = Jt = gn = cn = fn = dn = vn = pn = wn = Cn = xn = Mn = bn = Tn = Vt = Gt = null, this)
        ...
        function Xn() {
            lt && !At || (hi(), At ? (ie = Ti(), Me && (Te = _n()), de = le(), Nn(we || Te)) : Ji()),
            Z && Ai(),
            Yn(),
            Kn()
        }
        function Yn() {
            if (mi(), st.insertAdjacentHTML("afterbegin", '<div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">' + ai() + "</span>  of " + ht + "</div>"), bt = st.querySelector(".tns-liveregion .current"), Ie) {
                ...
                mn ? w(mn, {
                    "data-action": e
                }) : t.autoplayButtonOutput && (st.insertAdjacentHTML(Dn(t.autoplayPosition), '<button type="button" data-action="' + e + '">' + gn[0] + e + gn[1] + Yt[0] + "</button>"), mn = st.querySelector("[data-action]")),
                mn && O(mn, {
                    click: Wi
                }),
            ...
            De && (Xe || Ke && Je || (st.insertAdjacentHTML(Dn(t.controlsPosition), '<div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button" data-controls="prev" tabindex="-1" aria-controls="' + be + '">' + Ft[0] + '</button><button type="button" data-controls="next" tabindex="-1" aria-controls="' + be + '">' + Ft[1] + "</button></div>"), Xe = st.querySelector(".tns-controls")), Ke && Je || (Ke = Xe.children[0], Je = Xe.children[1]), t.controlsContainer && w(Xe, {
                ...
                "data-controls": "next"
            })), Ge = gi(Ke), Qe = gi(Je), wi(), Xe ? O(Xe, Ae) : (O(Ke, Ae), O(Je, Ae))),
            $n()
        }
        function Kn() {
            if (Z && Q) {
            ...
            if (yt) {
                ...
                if ((u || Nt && !At) && (en = Ui(), _i()), (o = se !== L) ? (ge.emit("indexChanged", Zi()), r = !0) : u ? o || di() : (Nt || At) && (oi(), mi(), ii()), u && !Z && function() {
                    for (var t = se + Math.min(ht, Ot), e = ee; e--;) {
                        var n = pt[e];
                        se <= e && e < t ? (m(n, "tns-moving"), n.style.left = 100 * (e - se) / Ot + "%", m(n, nt), y(n, rt)) : n.style.left && (n.style.left = "", m(n, rt), y(n, nt)),
                        y(n, it)
                    }
                    setTimeout((function() {
                        v(pt, (function(t) {
        ...
        function ri(t) {
            ...
            var e,
                ...
                i,
                a = se;
            if (Ht || Lt ? (At || Nt) && (n = -(parseFloat(t) + Lt), i = n + St + 2 * Lt) : At && (n = gt[se], i = n + St), At)
        ...
        function Bi(t, e) {
            ae && En(),
            (se !== ce || e) && (ge.emit("indexChanged", Zi()), ge.emit("transitionStart", Zi()), Wt && ci(), fn && t && 0 <= ["click", "keydown"].indexOf(t.type) && zi(), me = !0, An())
        }
        function Si(t) {
            ...
            if (Z || me) {
                ...
                if (!t || !Z && t.target.parentNode === ft || t.target === ft && Si(t.propertyName) === Si(re)) {
                    if (!ae) {
                        var i = se;
                        En(),
                        se !== i && (ge.emit("indexChanged", Zi()), Ai())
                    }
                    "inner" === _ && ge.emit("innerLoaded", Zi()),
                    me = !1,
                    ce = se
