    ...
    (n = function(t) {
        ...
        var n = e(2),
            ...
            s = c((function() {
                for (var t, r = this.iterator, e = this.predicate, n = this.next;;) {
                    if (t = a(o(n, r)), this.done = !!t.done)
                        return;
                    if (t = t.value, f(r, e, [t, this.counter++], !0))
                        return t
                }
            }));
        n({
        ...
        var n = e(2),
            ...
            p = f((function() {
                for (var t, r, e = this.iterator, n = this.mapper;;) {
                    ...
                    if (t = a(o(this.next, e)), this.done = !!t.done)
                        return;
                    try {
        ...
        N.prototype = {
            ...
            object: function() {
                for (var t = this.source, r = this.index + 1, e = !1, n = {}, o = {}; r < t.length;) {
                    ...
                    var i = this.fork(r).string(),
                        a = i.value;
                    r = i.end;
                    if (r = this.until([":"], r) + 1, r = this.skip(D, r), i = this.fork(r).parse(), g(o, a, i), g(n, a, i.value), r = this.until([",", "}"], i.end), "," == (i = R(t, r)))
                        e = !0,
                        r++;
                    else if ("}" == i) {
                        r++;
            ...
            array: function() {
                for (var t = this.source, r = this.index + 1, e = !1, n = [], o = []; r < t.length;) {
                    ...
                    if (T(o, i), T(n, i.value), r = this.until([",", "]"], i.end), "," == R(t, r))
                        e = !0,
                        r++;
                    else if ("]" == R(t, r)) {
                        r++;
            ...
            number: function() {
                ...
                if (!("." == R(t, e) && (e = this.skip(M, ++e)), "e" != R(t, e) && "E" != R(t, e) || ("+" != R(t, ++e) && "-" != R(t, e) || e++, e != (e = this.skip(M, e)))))
        ...
        o.prototype = {
            ...
            close: function() {
                var r,
                    e;
                u || (r = this.facade, e = this.subscriptionObserver, r.closed = !0, e && (e.closed = !0)),
                this.observer = t
            },
            isClosed: function() {
